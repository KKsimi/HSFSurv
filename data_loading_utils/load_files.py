...
def load_feature(feature_folder, patient_id, feature_dimension):
    file_path = feature_folder + '/' + patient_id + '-01Z-00-DX1.pt'
    feature = torch.load(file_path)
    return feature

# feature_folder = '/HSFSurv/COAD-feature/features/pt_files'
# patient_id = 'TCGA-F4-6461'
...
# z_score_path = '/HSFSurv/COAD-gene/coadread_tcga_pan_can_atlas_2018/data_mrna_seq_v2_rsem_zscores_ref_all_samples.txt'
...
#
# patient_id = 'TCGA-F4-6461'
# dict_family_genes = load_gene_family_info('/HSFSurv/gene_family/')
...
def get_overlapped_patient(path_img, path_clinical, path_genonmic1):
    ...
    df = pd.read_csv(path_genonmic1, delimiter = '\t')
...
# path_img = '/HSFSurv/COAD-feature/features/pt_files/'
# path_clinical = '/HSFSurv/COAD-gene/coadread_tcga_pan_can_atlas_2018/data_clinical_patient.csv'
# path_genonmic= '/HSFSurv/COAD-gene/coadread_tcga_pan_can_atlas_2018/data_mrna_seq_v2_rsem_zscores_ref_all_samples.txt'
#
